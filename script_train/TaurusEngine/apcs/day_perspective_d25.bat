...
for /f "tokens=1,2" %%a in ("%params%") do (
    ...
    start "APCS Optuna Day-Day MD0.25" cmd /C "call conda activate PY312_HT && cd ..\..\..\src\optimizers\apcs && python .\realtime_and_backtest_hyperparameter_search_optuna.py --dataset-id day --sell-offset !sell! --buy-offset !buy! --lookahead 1 --n-trials 99999 --timeout 3600 --min-density-threshold 0.25 --output-dir models\day_persective_d25 --verbose --verbose-list-trades"
