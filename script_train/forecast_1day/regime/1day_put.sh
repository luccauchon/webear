...
python regime_switching_optimizer.py --storage-url sqlite:///put_1_dayd1.db \
...
python regime_switching_optimizer.py --storage-url sqlite:///put_1_dayd2.db \
    --study-name put_1_day \
    --timeout "$TIMEOUT_VAL" \
    --spread-type put \
...
python regime_switching_optimizer.py --storage-url sqlite:///put_1_dayd3.db \
    --study-name put_1_day \
    --timeout "$TIMEOUT_VAL" \
    --spread-type put \
