...
def main(args):
    configuration = Namespace(
        ticker='^GSPC', col='Close', look_ahead=5, dataset_id='day',
        step_back_range=0,
        adj_call__ema=True, adj_put__ema=True, ema_short=16, ema_long=198, adj_call__ema_factor=1.01, adj_put__ema_factor=0.99,
        adj_call__rsi=True, adj_put__rsi=True, rsi_period=5, adj_call__rsi_factor=1.01, adj_put__rsi_factor=0.99,
        adj_call__macd=True, adj_put__macd=True, macd_fast_period=5, macd_slow_period=21, macd_signal_period=9, adj_call__macd_factor=1.01, adj_put__macd_factor=0.99,
        ...
        adj_call__sma=True, adj_call__sma_factor=1.01, adj_put__sma=True,  adj_put__sma_factor=0.99, sma_period=100,
