...
def main(args):
    ...
    threshold_for_shape_similarity = float(args.threshold_for_shape_similarity)
        ...
        if sell__call_credit_spread:
            ...
            if strategy_for_exit == 'hold_until_the_end_with_roll':
                ...
                if is_roll_being_requested:
                    ...
                    new_th1 = price_on_tm2 * (1. + 1.33*threshold_up_ep)  # th1
        ...
        if sell__put_credit_spread:
            ...
            if strategy_for_exit == 'hold_until_the_end_with_roll':
                ...
                if is_roll_being_requested:
                    # Roll it
                    price_on_tm2 = gt_prices[-2]
                    new_th2 = price_on_tm2 * (1. - 1.33*threshold_down_ep)  # th2
