...
python generate_json_for_visualization.py --clip --json-file taurus_visualization_clipped_week_%DATE_UNDERSCORE%.json --prime-rsi-target-dir D:\Finance\compiled_models\taurus\v1\2026.06.29\optimizers\prime_rsi --autotune-target-dir D:\Finance\compiled_models\taurus\v1\2026.06.29\optimizers\autotune --dgdr-target-dir D:\Finance\compiled_models\taurus\v1\2026.06.29\optimizers\dgdr --dataset-id week
