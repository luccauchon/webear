...
echo Using %PRIME_RSI_DAY_TARGET_DIR%

:: 
python player.py --nb-workers 20 --prime-rsi-target-dir %PRIME_RSI_DAY_TARGET_DIR% --dgdr-target-dir None --autotune-target-dir None --oerh-target-dir None  --verbose
