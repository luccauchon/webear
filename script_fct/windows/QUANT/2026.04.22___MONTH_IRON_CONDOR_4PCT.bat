...
echo ==========================================================================
python .\quant_model_trainer.py --real-time --model-path D:\Finance\compiled_models\quant\2026.04.22\best_model_RandomForestClassifier_in_between_20260422_064325.pkl --dataset D:\Finance\compiled_models\quant\2026.04.22\generated__combined_monthly_macro.data
pause
